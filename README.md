...
Neural Flow is a web-based application that trains students' executive function skills through gamified cognitive tasks integrated with K-12 science curricula. It evaluates working memory, sustained attention, cognitive flexibility, and processing speed.
...
2. Enter your name, age, and grade on the launch screen.
3. Complete all four training modules.
4. Review your report with personalized study strategies.
